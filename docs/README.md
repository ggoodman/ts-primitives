...
* [_translationsConfigFile](README.md#let-_translationsconfigfile)
...
▸ **encodeURIComponentFast**(`uriComponent`: string, `allowSlash`: boolean): *string*
